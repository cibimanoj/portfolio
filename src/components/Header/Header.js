...
const Header = () =>  (
  <Container>
    <Div1>
      <Link href="https://drive.google.com/file/d/1CDjmiaiGtccJtzjmga8Z2wTVqOJn4k_N/view?usp=sharing">
        <a target="_blank"style={{ display: 'flex', alignItems: 'center', color:"white" }}>
          <DiGoogleDrive size="3rem" /> <span>Resume</span>
        </a>
      </Link>
    </Div1>
    <Div2>
